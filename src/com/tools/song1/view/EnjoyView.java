...
public class EnjoyView {
	...
	protected void createContents() {
		shlcd = new Shell();
		shlcd.setSize(688, 569);
		shlcd.setText("享CD文件数据处理工具");
		shlcd.setLayout(new GridLayout(1, false));
								...
								lblNewLabel.setText("选择地域目录：");
										...
										btnNewButton.addSelectionListener(new SelectionAdapter() {
											public void widgetSelected(SelectionEvent e) {
												String singerTypeFloder = folderDig(shlcd);
						...
						lblNewLabel_1.setText("选择风格目录：");
								...
								text_1.setBounds(108, 26, 419, 23);
										...
										btnNewButton_1.addSelectionListener(new SelectionAdapter() {
											public void widgetSelected(SelectionEvent e) {
												String albumStyleFloder = folderDig(shlcd);
