...
public class EnjoyByAlbumComposite extends Composite {
	private Text text;
	private Text text_1;
	private Text text_2;
	private Text text_3;
	 ...
	 * @param style
	 */
	public EnjoyByAlbumComposite(Composite parent, int style) {
		super(parent, style);
		setSize(780, 300);
		...
		fd_group.bottom = new FormAttachment(100, -75);
		
		Label lblNewLabel_5 = new Label(group, SWT.NONE);
		lblNewLabel_5.setLayoutData(new GridData(SWT.RIGHT, SWT.CENTER, false, false, 1, 1));
		lblNewLabel_5.setText("专辑风格目录：");
		...
		gd_btnNewButton_3.widthHint = 76;
		...
		fd_btnNewButton_2.top = new FormAttachment(group, 16);
		fd_btnNewButton_2.right = new FormAttachment(group, 0, SWT.RIGHT);
		fd_btnNewButton_2.left = new FormAttachment(0, 596);
		fd_btnNewButton_2.bottom = new FormAttachment(100, -21);
