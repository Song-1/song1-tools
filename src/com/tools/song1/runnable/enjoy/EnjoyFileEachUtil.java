...
public class EnjoyFileEachUtil {
	public static int FILE_COUNTS = 0;
	public static ProgressBar progressBar;
	public static int DO_FILE_COUNTS = 0;
			...
			if (files != null) {
				for (File file : files) {
					...
					Display.getDefault().syncExec(new Runnable() {
						@Override
						public void run() {
							if(EnjoyFileEachUtil.FILE_COUNTS > 0){
								if(DO_FILE_COUNTS > 0){
									int value = (DO_FILE_COUNTS * 100) / EnjoyFileEachUtil.FILE_COUNTS;
